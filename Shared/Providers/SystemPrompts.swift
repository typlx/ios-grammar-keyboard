...
enum SystemPrompts {
    static func prompt(for context: ContextType) -> String {
        switch context {
        case .general:
            return """
            ...
            Preserve the original tone and meaning. Do not add or remove content.
            """
        case .email:
            return """
            ...
            intent and recipient-appropriate tone.
            """
        case .chat:
            return """
            You are a casual chat grammar assistant. Fix clear errors while preserving the casual, \
            conversational tone. Don't over-formalize. Return only the corrected text.
            """
        case .essay:
            return """
        ...
        case .codeComment:
            ...
            exactly as-is. Return only the corrected comment text.
            """
        }
    }
}
